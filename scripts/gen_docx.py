...
def build_report():
    ...
    questions = [
        ...
        ("Câu hỏi 14: Vì sao TerriMap ưu tiên thuật toán dựa trên adjacency graph?",
         "Trả lời: Bài toán thiết kế vùng thương mại cần nhiều hơn việc gom các điểm gần nhau. Mỗi district phải cân bằng tải trọng, có thể kiểm tra liên thông địa lý, và hỗ trợ điều chỉnh thủ công mà không phá vỡ ràng buộc. Do đó, TerriMap dùng Greedy loang BFS để tạo nghiệm ban đầu, Local Search để cải thiện biên an toàn, và Simulated Annealing để tối ưu hóa đa mục tiêu hàm cost."),
