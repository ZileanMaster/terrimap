...
<head>
  ...
  <style>
    body { font-family: 'Noto Sans Vietnamese', 'Segoe UI', Roboto, -apple-system, sans-serif; max-width: 800px; margin: 0 auto; padding: 40px 20px; color: #1a1a1a; }
...
<body>
  ...
  <div class="footer">
    Generated by Commercial Territory Design System — ${report.snapshotCount} snapshots saved
  </div>
</body>
</html>`
